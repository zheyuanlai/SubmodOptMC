...
def plot_objective_per_iteration(f_values):
    ...
    plt.ylabel("Entropy rate of the output of greedy algorithm")
    plt.grid(True)
    plt.savefig("greedy_entropy_rate.png")
    #plt.show()
...
if __name__ == "__main__":
    ...
    function_values = [
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10, 11})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10, 11, 12})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10, 11, 12, 13})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10, 11, 12, 13, 14})).item(),
        compute_entropy_rate(keep_S_in_mat(P, state_vals, {2, 3, 4, 5, 1, 6, 7, 8, 9, 10, 11, 12, 13, 14, 0})).item(),
    ]
